# <img src="https://matterbridge.io/assets/matterbridge.svg" alt="Matterbridge Logo" width="32px" height="32px"> &nbsp;&nbsp;&nbsp; Matterbridge Application (Legacy) Changelog
...
- Updated matterbridge-hass to [1.0.12](https://github.com/Luligu/matterbridge-hass/blob/main/CHANGELOG.md#111---2026-04-17).
...
- Initial release of the Matterbridge Official Home Assistant Application (Legacy).
